    ...
    <footer className="mt-auto border-t border-border bg-white">
      <div className="mx-auto max-w-7xl px-4 py-10 md:py-14">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          {/* Company */}
          <div>
            <p className="mb-3 text-xs font-semibold uppercase tracking-widest text-text-main">Company</p>
            <ul className="space-y-2 text-sm text-text-sub">
              <li><span className="cursor-default">About Us</span></li>
              <li><span className="cursor-default">B2B Inquiries</span></li>
              <li><span className="cursor-default">Wholesale</span></li>
              <li><a href="/admin/dashboard" className="hover:text-primary transition-colors">Admin</a></li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <p className="mb-3 text-xs font-semibold uppercase tracking-widest text-text-main">Contact</p>
            <ul className="space-y-2 text-sm text-text-sub">
              <li>orders@haetae.com</li>
              <li>B2B: biz@haetae.com</li>
